...
class Drawer extends React.Component<{}, DrawerState> {
    ...
    componentDidMount() {
        if (this.canvasRef.current) {
            ...
            this.canvasRef.current.onmousedown = (e: MouseEvent) => this.onMouseDown(e);
            this.canvasRef.current.onmouseup = (e:MouseEvent) => this.onMouseUp(e);
            this.canvasRef.current.onmouseleave = (e: MouseEvent) =>  this.onMouseLeave(e);
            this.canvasRef.current.onmousemove = (e: MouseEvent) => this.onMouseMoved(e);
        }
    }
    ...
    render() {
        return (
            <div>
                <canvas ref={this.canvasRef} height={500} width={500}>
                </canvas>
            </div>
        )
    }
